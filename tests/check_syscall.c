...
START_TEST(check_syscall_check_chown_predict_write_deny) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown_predict_write_predict) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown_predict_write_allow) {
    pid_t pid;
...
#if defined(I386)
START_TEST(check_syscall_check_chown32_deny) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown32_predict) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown32_allow) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown32_predict_write_deny) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown32_predict_write_predict) {
    pid_t pid;
...
START_TEST(check_syscall_check_chown32_predict_write_allow) {
    pid_t pid;
...
Suite *syscall_suite_create(void) {
    ...
    tcase_add_test(tc_syscall_check, check_syscall_check_chown_predict_write_deny);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown_predict_write_predict);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown_predict_write_allow);
#if defined(I386)
    tcase_add_test(tc_syscall_check, check_syscall_check_chown32_deny);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown32_predict);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown32_allow);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown32_predict_write_deny);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown32_predict_write_predict);
    tcase_add_test(tc_syscall_check, check_syscall_check_chown32_predict_write_allow);
#endif
